...
import com.vosievskaya.controller.Controller;
...
public class MainServlet extends HttpServlet {
    ...
    static {
        ...
        controllerMap.put(Request.of("GET", "/servlet/product"), getProductByIdController(getProductService(getProductDao(getConnection()))));
